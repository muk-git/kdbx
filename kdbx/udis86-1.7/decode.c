...
search:
    ...
    case UD_Igrp_vendor:
        if ( u->vendor == UD_VENDOR_INTEL ) 
            ...
            kdbxp("KDB:search_itab(): unrecognized vendor id\n");
            return -1;
        }
        break;

    case UD_Id3vil:
        kdbxp("KDB:search_itab(): invalid instr mnemonic constant Id3vil\n");
        return -1;

    default:
        kdbxp("KDB:search_itab(): invalid instruction mnemonic constant\n");
        return -1;
    }
